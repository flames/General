...
public class Misc {
	 ...
	 */
	public Boolean is(String text, String against) {
	 ...
	 * @return <code>Boolean</code> - True or false based on text.
	 */
	public Boolean isEither(String text, String against, String or) {
	 ...
	 */
	public static String stringStatic(int i) {
	...
	/**
	 * Turns "SomeName" into "Some Name" or "MyABC" into "My ABC". (Inserts a
	 * space before a capital letter unless it is at the beginning of the string
	 * or preceded by a capital letter.)
	 */
